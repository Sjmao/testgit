...
public class EntityDao extends AbstractDao<Entity, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Test = new Property(4, Double.class, "test", false, "TEST");
    };
    ...
    protected void bindValues(SQLiteStatement stmt, Entity entity) {
        ...
        Double test = entity.getTest();
        if (test != null) {
            stmt.bindDouble(5, test);
        }
    }
    ...
    public Entity readEntity(Cursor cursor, int offset) {
        Entity entity = new Entity( //
            ...
            cursor.isNull(offset + 4) ? null : cursor.getDouble(offset + 4) // test
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Entity entity, int offset) {
        ...
        entity.setTest(cursor.isNull(offset + 4) ? null : cursor.getDouble(offset + 4));
     }
